                            ...
                            <div className="row"> 
                                <div className="col-sm-4"> 
                                    <div className="organic-prod">
                                        ...
                                        <h3 className="title-1"> <Link to="/"> <span className="light-font">organic </span> <strong> fruits</strong> </Link> </h3>
                                ...
                                <div className="col-sm-4"> 
                                    <div className="organic-prod">
                                        ...
                                        <span className="divider"></span>
                                        <h3 className="title-1"> <Link to="/"> <span className="light-font">fresh </span> <strong> vegetables</strong> </Link> </h3>
                                ...
                                <div className="col-sm-4"> 
                                    <div className="organic-prod">
                                        ...
                                        <span className="divider"></span>
                                        <h3 className="title-1"> <Link to="/"> <span className="light-font">organic </span> <strong> breads</strong> </Link> </h3>
                            ...
                            <div className="row"> 
                                <div className="col-sm-4"> 
                                    <div className="organic-prod">
                                        ...
                                        <span className="divider"></span>
                                        <h3 className="title-1"> <Link to="/"> <span className="light-font">organic </span> <strong> juices</strong> </Link> </h3>
                                ...
                                <div className="col-sm-4"> 
                                    <div className="organic-prod">
                                        ...
                                        <span className="divider"></span>
                                        <h3 className="title-1"> <Link to="/"> <span className="light-font">dried </span> <strong> juices</strong> </Link> </h3>
                                ...
                                <div className="col-sm-4"> 
                                    <div className="organic-prod">
                                        ...
                                        <span className="divider"></span>
                                        <h3 className="title-1"> <Link to="/"> <span className="light-font">organic </span> <strong> tea</strong> </Link> </h3>
